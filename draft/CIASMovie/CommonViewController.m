...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self.view setBackgroundColor:[UIColor colorWithHex:[UIConstants sharedDataEngine].viewControllerBackgroundColor]];
    [self setStatusBarLightStyle];
    self.contentPositionY = 20;
...
//        //设置导航栏背景色
//        self.navBarView.backgroundColor = [UIColor colorWithHex:[UIConstants sharedDataEngine].navigationBarBackgroundColor];
//        self.statusView.backgroundColor = [UIColor colorWithHex:[UIConstants sharedDataEngine].navigationBarBackgroundColor];
//    }
    ...
    if (!_changeStatusView) {
        ...
        if ([self changeRightButtonImage]) {
            ...
            self.changeRightBtn.frame = CGRectMake(
                    kCommonScreenWidth - rightImg.size.width - rightButtonRight * 2,
...
- (UIButton *)kkzBackBtn {
    if (!_kkzBackBtn) {
        ...
        [_kkzBackBtn setImage:[UIImage imageNamed:@"mBack"]
