...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/CacheEngine/CacheEngine.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/Category_KKZ/Category_KKZ.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/DateEngine_KKZ/DateEngine_KKZ.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/HallView_KKZ/HallView_KKZ.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NetCore_KKZ/NetCore_KKZ.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NetCore_KKZ_Cache/NetCore_KKZ_Cache.framework"
