...
@interface OrderConfirmViewController : UIViewController<UITableViewDelegate, UITableViewDataSource, UIScrollViewDelegate, ProductViewDelegate, PayTypeHeaderViewDelegate, CodeViewDelegate, ProductListViewDelegate, PromotionListViewDelegate>
{
    //影票信息
...
@property (nonatomic, copy) NSString *selectActivityType;
...
@property (nonatomic, strong) NSMutableArray *selectCouponModelList;

@property (nonatomic, assign) NSInteger selectedSection;
@property (nonatomic, strong) UIVisualEffectView * blurEffectView;
@property (nonatomic, strong) CodeView * codeViewForOrderConfirm;

//自营为YES  系统方为NO
@property (nonatomic, assign) BOOL productType;//卖品类型
@property (nonatomic, assign) BOOL promotionType;//活动类型
@property (nonatomic, assign) BOOL storeVipCardType;//储值卡类型
