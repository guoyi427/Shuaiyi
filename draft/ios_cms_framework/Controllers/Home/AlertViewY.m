...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.vBg = [[UIImageView alloc] initWithFrame:CGRectMake((kCommonScreenWidth - 55) * 0.5,0, 52, 52)];
        ...
        UIImageView *v = [[UIImageView alloc] initWithFrame:CGRectMake((kCommonScreenWidth - 55) * 0.5,0, 52, 52)];
        ...
        self.alertView = v;
        [self startAnimation];
        UILabel *lbl = [[UILabel alloc] initWithFrame:CGRectMake(15, CGRectGetMaxY(v.frame),kCommonScreenWidth - 15 * 2,20)];
        lbl.numberOfLines = 0;
...
-(void)setAlertViewImage:(NSString *)name{
    ...
    self.alertLabel.textColor = [UIColor colorWithRed:172/255.0 green:172/255.0 blue:172/255.0f alpha:1];//[UIColor r:172 g:172 b:172];
}
