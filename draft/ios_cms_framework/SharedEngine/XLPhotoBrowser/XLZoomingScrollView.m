...
//        _progressView = [[XLProgressView alloc] initWithFrame:CGRectMake(kCommonScreenWidth/2 - 50, kCommonScreenHeight/2 - 50, 100, 100)];
...
- (void)setShowHighQualityImageWithURL:(NSURL *)url placeholderImage:(UIImage *)placeholder
{
    ...
    [self.photoImageView sd_setImageWithURL:url
        ...
        if (weakSelf.progressView.superview) {
