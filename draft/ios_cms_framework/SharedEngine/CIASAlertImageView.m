...
@implementation CIASAlertImageView
...
- (void) setup
{
    ...
    [cancle setTitleColor:[UIColor colorWithHex:@"#b2b2b2"] forState:UIControlStateNormal];
    ...
    [confirm setTitleColor:[UIColor colorWithHex:@"#ff9900"] forState:UIControlStateNormal];
