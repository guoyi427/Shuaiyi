...
//  CIASMovie
//
//  Created by avatar on 2017/2/22.
//  Copyright © 2017年 cias. All rights reserved.
//

#import "CodeResendView.h"

@interface CodeResendView()
#define  kCoverViewTag 10011520
...
- (void)setUnderlineTextWithRange:(NSRange)underlineTextRange withUnderlineColor:(UIColor *)color withClickCoverColor:(UIColor *)coverColor withBlock:(codeResendViewPartBlock)block
{
...
//            cover.backgroundColor = dic[@"coverColor"];
    ...
    if (selectedArray.count) {
        ...
        codeResendViewPartBlock block = dic[@"block"];
        if (dic[@"coverColor"]) {
