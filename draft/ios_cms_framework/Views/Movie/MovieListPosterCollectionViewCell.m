...
//        movieNameLabel.frame = CGRectMake(0, 220, 105, 15);
        ...
        scoreLabel = [self getFlagLabelWithFont:10 withBgColor:[UIConstants sharedDataEngine].withColor withTextColor:@"#000000"];
...
//    self.movieName = @"神奇动物在哪里";
    ...
    [self.moviePosterImage sd_setImageWithURL:[CIASPublicUtility getUrlDeleteChineseWithString:self.imageUrl] placeholderImage:placeHolderImage];
    movieNameLabel.text = self.movieName;
...
//        [movieNameLabel setFrame:CGRectMake(0, 181-20, movieNameSize.width, 15)];
    ...
    if (self.point.length) {
        ...
        CGSize scoreSize = [KKZTextUtility measureText:self.point font:[UIFont systemFontOfSize:10]];
    ...
    if (self.availableScreenType.length) {
        ...
        CGSize screenTypeSize = [KKZTextUtility measureText:self.availableScreenType font:[UIFont systemFontOfSize:10]];
