...
//添加代理方法
@protocol UserForgetPWCodeViewDelegate <NSObject>
...
@interface UserForgetPWCodeView : UIView<UITextFieldDelegate, UIScrollViewDelegate>
{
...
@property (nonatomic, weak) id <UserForgetPWCodeViewDelegate> delegate;
