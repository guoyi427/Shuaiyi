...
-(void)updateButtonFormatForUIControlState:(UIControlState)state{
    ...
    //            [self setImage:[UIImage imageNamed:[self buttonIconString]] forState:UIControlStateNormal];
    //
    //        }
    //        else if([self buttonIcon]){
    //            [mutableStringIcon appendAttributedString:[[NSAttributedString alloc] initWithString:[self buttonIcon]]];
    //            [self setImage:[UIImage imageNamed:[self buttonIcon]] forState:UIControlStateNormal];
    //
    //        }
    //
    //        //Setting color
...
-(void)setTextColor:(UIColor *)color forUIControlState:(UIControlState)state {
