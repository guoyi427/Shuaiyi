...
- (void)updateMovieHobbyCell {
    [hobbyImgV loadImageWithURL:self.hobbyPicUrl andSize:ImageSizeSmall];

    hobbyTitleLbl.text = self.hobbyTitle;

    CGFloat hobbyPriceP = [self.hobbyPrice floatValue];
    ...
    CGFloat hobbyPromotionPriceP = [self.hobbyPromotionPrice floatValue];
