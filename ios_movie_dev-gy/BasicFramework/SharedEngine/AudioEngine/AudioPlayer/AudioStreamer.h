...
@interface AudioStreamer : NSObject
{
	...
	long long dataOffset;		// Offset of the first audio packet in the stream
	long long fileLength;		// Length of the file in bytes
	long long seekByteOffset;	// Seek offset within the file in bytes
