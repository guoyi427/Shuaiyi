...
NSString *playImage = @"audio_play_btn";
NSString *stopImage = @"audio_stop_btn";
...
- (void)startSpin
{
    if (!loadingView) {
        ...
        loadingView.image = [UIImage imageNamed:@"audio_loading"];
	...
	animation = [CABasicAnimation animationWithKeyPath:@"audio_loading"];
