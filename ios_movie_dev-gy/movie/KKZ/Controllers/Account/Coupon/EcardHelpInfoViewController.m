...
- (void)viewDidLoad {
    ...
    [self showMessageWithTitle:@"什么是优惠券/抵扣券？"
                         andMsg1:@"优惠券/"
                                 @"抵扣券是章鱼电影发行和认可的购物券，可以在章鱼电影消费付款时抵扣相应面值的金额。章鱼电影"
                                 @"的优惠券/抵扣券发放方式一般分为：公司团购；参与章鱼电影线上活动；市场合作类等。"
                         andMsg2:@""
    ...
    [self showMessageWithTitle:@"如何获取优惠券/抵扣券"
                         andMsg1:@"章鱼电影客户端和网站会不定期推出优惠券/"
                                 @"抵扣券相关活动，您可以经常打开章鱼电影，关注活动通知，及时参与优惠券/抵扣券活动。"
                         andMsg2:@""
                    andPositionY:positionY];
